  ...
  return (
    <header
      className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 ${
        scrolled ? "border-b border-border-hair bg-bg-base/85 backdrop-blur-xl" : "bg-transparent"
      }`}
    >
      ...
      <nav className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="grid h-11 w-11 place-items-center rounded-lg border border-border-hair bg-bg-glass text-text-primary backdrop-blur md:hidden"
          >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="border-t border-border-hair bg-bg-base/97 backdrop-blur-xl md:hidden"
          >
